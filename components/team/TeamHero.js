...
const TeamHero = () => {
  return (
    <>
      <div className="grid grid-cols-2 mt-8 mb-[105px] lg:mb-[0px] gap-6 lg:min-h-[700px] items-center">
        <div className="col-span-2 lg:col-span-1 flex flex-col gap-6 my-3 justify-center items-center lg:items-start lg:pr-40">
          ...
          <p className="text-center lg:text-left text-sm">
            ...
            greater social purpose is at our core. We believe education, charity
            and business are inextricably linked through the communities they
            serve. As a local company with renowned, international partnerships,
            we successfully harness the depth and breadth of our relationships
            to cultivate meaningful connections. We use our marketing and
            communications expertise to join the dots.
          </p>
        </div>
